from hero import Healer, Mage, Warrior
...
class Player:
    ...
    def set_starting_pos(self):
        if self.player_id == 1:
            side = "west"
            return [Healer(0, [11, 1], side), Mage(1, [11, 4], side),  Warrior(2, [11, 7], side),  Mage(3, [11, 10], side)]
        else:
            return [Healer(0, [0, 1]), Mage(1, [0, 4]),  Warrior(2, [0, 7]),  Mage(3, [0, 10])]
