from hero import Hero, Healer, Mage, Warrior
...
class Player:
    ...
    def set_starting_pos(self):
        if self.player_id == 1:
            return [Healer(0, [11, 0], side="west"), Mage(1, [11, 1], side="west"), Warrior(2, [11, 2], side="west")]
        else:
            return [Healer(0, [0, 0]), Mage(1, [0, 1]), Warrior(2, [0, 2])]
